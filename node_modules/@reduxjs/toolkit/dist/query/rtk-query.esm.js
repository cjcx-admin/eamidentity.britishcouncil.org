                ...
                switch (_o.label) {
                    case 0:
                        _a2 = typeof arg == "string" ? {
                            url: arg
                        } : arg, url = _a2.url, _f = _a2.method, method = _f === void 0 ? "GET" : _f, _g = _a2.headers, headers = _g === void 0 ? new Headers({}) : _g, _h = _a2.body, body = _h === void 0 ? void 0 : _h, _j = _a2.params, params = _j === void 0 ? void 0 : _j, _k = _a2.responseHandler, responseHandler = _k === void 0 ? "json" : _k, _l = _a2.validateStatus, validateStatus = _l === void 0 ? defaultValidateStatus : _l, rest = __objRest(_a2, [
                            "url",
                            "method",
                            "headers",
                            "body",
                        ...
                        _m = config;
                        return [4 /*yield*/ , prepareHeaders(new Headers(stripUndefined(headers)), {
                            getState: getState
                        })];
                    case 1:
                        _m.headers = _o.sent();
        ...
        return __async(_this, [_0, _1], function(arg, _e) {
            ...
            return __generator(this, function(_g) {
                switch (_g.label) {
                    ...
                    case 6:
                        return [2 /*return*/ , _f.apply(void 0, [_g.sent(), {
                    ...
                    case 7:
                        ...
                        if (error_1 instanceof HandledError) {
                            return [2 /*return*/ , rejectWithValue(error_1.value, {
...
import {
    ...
    createSlice,
    isAnyOf,
    isFulfilled as isFulfilled2,
    isRejectedWithValue as isRejectedWithValue2
} from "@reduxjs/toolkit";
import {
    applyPatches
} from "immer";
...
import {
    isAnyOf as isAnyOf2,
    isFulfilled as isFulfilled3,
    isRejectedWithValue as isRejectedWithValue3
} from "@reduxjs/toolkit";
...
import {
    isPending as isPending2,
    isRejected as isRejected2,
    isFulfilled as isFulfilled5
} from "@reduxjs/toolkit";
...
function buildInitiate(_e) {
    ...
    var _f = api.internalActions,
        unsubscribeQueryResult = _f.unsubscribeQueryResult,
        unsubscribeMutationResult = _f.unsubscribeMutationResult,
        ...
        return function(arg, _e) {
            ...
            return function(dispatch, getState) {
                ...
                return Object.assign(returnValuePromise, {
                    ...
                    unsubscribe: function() {
                        if (track)
                            dispatch(unsubscribeMutationResult({
                                requestId: requestId
                            }));
                    }
                });
