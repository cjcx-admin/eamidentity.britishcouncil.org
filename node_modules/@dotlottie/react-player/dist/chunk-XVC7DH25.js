...
var b = v ? window : null,
    ...
    B = function(e, o, t, r) {
        t === void 0 && (t = b), useEffect(function() {
            if (o && t) return y(t) ? m(t, e, o, r) : L(t) && t.on(e, o, r),
                function() {
...
var C = createContext(null),
    ...
    pe = () => {
        let e = useContext(C);
        if (typeof e > "u") throw createError("useDotLottieContext must be used within a DotLottieProvider");
        return e
    };
var ve = (e, o, t) => {
    let [r, u] = useState(() => t());
...
export {
    P as a, F as b, A as c, ve as d, de as e, pe as f
};
