...
var Me = {
    ...
    ne = ({
        ...
        let [t, r] = Ne(e.options), a = c => {
            var u;
            return ((u = e.overrideStrings) == null ? void 0 : u[c]) || Me[c]
        };
        return Pe(() => {
            r(e.options)
        }, [e.options]), Te(re.Provider, {
            value: {
                t: a,
                ...De,
                ...e,
...
function R(e, n, t) {
    let r = We(() => Array.isArray(e) ? e : [e], [e]),
        a = Object.assign({}, He, t),
        {
            when: c,
            eventTypes: u
        } = a,
...
function ie(e, n) {
    return n ? e.filter(({
        label: t,
        value: r
    }) => t != null && r != null && t.toLowerCase().includes(n.toLowerCase())) : e
}
import {
    jsx as ce,
    jsxs as Be
...
var Je = () => {
        let {
            ...
            isCreatable: L,
            onCreateOption: y
        } = w(), O = Y(), g = Y(), [m, M] = F(""), [v, K] = F(t), [x, D] = F(""), [E, I] = F(0), W = Ge(le(o => D(o), l), []), A = he(() => {
            let o = 0;
...
var xe = () => {
    let {
        ...
        options: t,
        valueRenderer: r
    } = w(), a = n.length === 0, c = n.length === t.length, u = r && r(n, t);
    return a ? ve("span", {
        className: "gray",
...
var Xe = () => {
        let {
            ...
            defaultIsOpen: i,
            ClearSelectedIcon: l,
            closeOnChangedValue: L
        } = w();
        ye(() => {
            L && m(!1)
        }, [s]);
        let [y, O] = J(!0), [g, m] = J(i), [M, v] = J(!1), K = t || ge, x = Qe();
        se(() => {
            n && n(g)
        }, [g]), ye(() => {
        ...
        let D = h => {
            var P;
            ["text", "button"].includes(h.target.type) && [f.SPACE, f.ENTER].includes(h.code) || (y && (h.code === f.ESCAPE ? (m(!1), (P = x == null ? void 0 : x.current) == null || P.focus()) : m(!0)), h.preventDefault())
        };
        R([f.ENTER, f.ARROW_DOWN, f.SPACE, f.ESCAPE], D, {
            target: x
        });
        let E = h => {
                y && r && m(h)
        ...
        return Ce("div", {
            ...
            children: [Ce("div", {
                ...
                children: [S("div", {
                    ...
                    children: S(xe, {})
                }), a && S(Se, {}), s.length > 0 && l !== null && S("button", {
                    type: "button",
...
var Ze = e => X(ne, {
    ...
    je = Ze;
export {
    Q as Dropdown, je as MultiSelect, N as SelectItem, q as SelectPanel
};