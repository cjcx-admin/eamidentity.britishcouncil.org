...
const Document = forwardRef(function Document(_a, ref) {
    var {
        ...
        renderMode,
        rotate
    } = _a, otherProps = __rest(_a, ["children", "className", "error", "externalLinkRel", "externalLinkTarget", "file", "inputRef", "imageResourcesPath", "loading", "noData", "onItemClick", "onLoadError", "onLoadProgress", "onLoadSuccess", "onPassword", "onSourceError", "onSourceSuccess", "options", "renderMode", "rotate"]);
    ...
    const findDocumentSource = useCallback(() => __awaiter(this, void 0, void 0, function*() {
        ...
        if ('url' in file && typeof file.url === 'string') {
            if (isDataURI(file.url)) {
                const {
                    url
                } = file, otherParams = __rest(file, ["url"]);
