...
class Modal extends React.Component {
    constructor(props) {
        ...
        this.checkUnderlayClick = (event) => {
            if ((this.dialogNode && event.target instanceof Node && this.dialogNode.contains(event.target)) ||
    ...
    render() {
        ...
        const childrenArray = [
            React.createElement("div", Object.assign({}, dialogProps), props.children),
        ];
        if (props.verticallyCenter) {
            childrenArray.unshift(React.createElement("div", {
                key: "a",
